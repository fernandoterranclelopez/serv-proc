...
//describir lass optiones para getopt long
...
//Descripcion opciones cortas para getoptlong
static const char *const short_options = "a_hm:p:v";
//Usar texto de sumario
static const char *const usage_template =
"Usage: %s[options]\n"
" -a, --address ADDR    Bind to local address(by default, bind\n"
"                          to all locall address).\n"
" -h, --help            Print this information.\n"
" -m, --module-dir DIR  Load modules from specified directory.\n"
"                        (by default, use executable directory).\n"
" -p, --port PORT       Bind to specified port.\n"
" -v, --verbose         Print verbose message.\n";
//Imprimir la informacion y salir . Si el error no es 0, escribir en el stderr y usar un error de salida
//Sino imprimir en el stdout y usar una terminacion que no da error
...
main(int argc, char *argv[]){
        ...
        program_name = argv[0];
        local_address.s_addr = INADOR_ANY;
        port = 0;
        verbose = 0;
                ...
                switch(next_option){
                        ...
                        case 'm':
                                ...
                                if(access(optarg,F_OK) != 0)
                                        error(optarg, "module directory doesnt exists");
                                //Mirar si es accesible
                                if(access(optarg, R_OK | X_OK) != 0)
                                        error(optarg,"module directory isnt accesible");
                                //Estar seguro de que es un directorio
